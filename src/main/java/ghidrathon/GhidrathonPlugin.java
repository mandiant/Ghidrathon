...
public class GhidrathonPlugin extends ProgramPlugin implements InterpreterConnection, OptionsChangeListener {
	...
	private void resetInterpreter() {
		...
		TaskLauncher.launchModal("Resetting Ghidrathon...", () -> {
