...
public class GhidrathonScript extends GhidraScript {
	...
	/**
	 * Execute Python script using given script state
	 * See https://github.com/NationalSecurityAgency/ghidra/blob/master/Ghidra/Features/Python/src/main/java/ghidra/python/PythonScript.java#L53
	 * 
